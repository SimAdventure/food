    ...
    menu: [
        {
            ...
            additives: ["Extra Cheese", "Coke", "Fries", "Onions", "Bacon"],
        },
        {
        ...
        },
        {
            ...
            additives: ["Jalapeños", "Iced Tea", "Fries", "Salad"],
        },
        {
            ...
            protein: 29,
            category_name: "Burgers",
            additives: ["Onions", "Fries", "Coke", "Bacon", "Avocado"],
        },
        {
            ...
            protein: 28,
            category_name: "Wraps",
            additives: ["Extra Cheese", "Coke", "Potato Wedges", "Tomatoes"],
        },
        {
            ...
            additives: ["Mushrooms", "Olives", "Mozzarella Sticks", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 20,
            category_name: "Wraps",
            additives: ["Jalapeños", "Tomatoes", "Salad", "Fries", "Iced Tea"],
        },
        {
            ...
            protein: 24,
            category_name: "Bowls",
            additives: ["Avocado", "Sweet Corn", "Salad", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 21,
            category_name: "Pizzas",
            additives: ["Extra Cheese", "Olives", "Coke", "Garlic Bread"],
        },
        {
            ...
            protein: 38,
            category_name: "Bowls",
            additives: ["Avocado", "Salad", "Sweet Corn", "Iced Tea"],
        },
        {
            name: "Paneer Burrito",
            ...
            protein: 22,
            category_name: "Burritos",
            additives: ["Jalapeños", "Fries", "Garlic Bread", "Coke"],
        },
        {
            ...
            protein: 31,
            category_name: "Sandwiches",
            additives: ["Bacon", "Tomatoes", "Mozzarella Sticks", "Iced Tea"],
        },
    ],
};
